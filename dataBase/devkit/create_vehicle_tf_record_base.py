...
def parse_args(check=True):
    ...
    parser.add_argument('--data_dir', type=str, default='/home/xiaohui/AI/VehicleDetectionModelIdentification/dataBase/quiz-w8-data',
                        help='Root directory to raw pet dataset.')
...
def dict_to_tf_example(data,
    ...
    print ('wwwwwwwwwwwwwwwwwwww',width)
    print ('hhhhhhhhhhhhhhhhhhhh',height)
    xmins = []
    ymins = []
    xmaxs = []
    ymaxs = []
